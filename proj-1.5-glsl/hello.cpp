...
int main()
{
    ...
    // fragment shader for blue
    int fragmentShader_blue = glCreateShader(GL_FRAGMENT_SHADER);
    ...
    // link shaders fow blue
    int shaderProgram_blue = glCreateProgram();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        int vertexColorLocation = glGetUniformLocation(shaderProgram_blue, "ourColor");
